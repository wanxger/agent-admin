...
- [x] 5.1 创建 test/integration/protocol.test.ts 文件
- [x] 5.2 编写 ACP 协议参数传递测试（使用 TestAgent）
- [x] 5.3 编写会话管理测试（使用 TestAgent）
- [x] 5.4 编写消息序号测试（使用 TestAgent）
- [x] 5.5 编写错误处理测试（使用 TestAgent）
...
- [x] 7.2 运行集成测试：pnpm test（在 libs/prompt 中）
- [x] 7.3 检查测试覆盖率报告
